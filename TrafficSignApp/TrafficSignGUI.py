...
top.configure(background='#04b6b6')

# Name of the Sign
label = Label(top, background='#000016', font=('arial',30,'bold'))
...
def show_classify_button(file_path):
    ...
    classify_b.configure(background='#000016', foreground='white',font=('arial',10,'bold'))
...
upload.configure(background='#000016', foreground='white',font=('arial',10,'bold'))

upload.pack(side=BOTTOM,pady=50)
sign_image.pack(side=BOTTOM,expand=True)
label.pack(side=BOTTOM,expand=True)
heading = Label(top, text="Know Your Traffic Sign",pady=20, font=('arial',20,'bold'))
heading.configure(background='#04b6b6',foreground='#000016')
heading.pack()
top.mainloop()
